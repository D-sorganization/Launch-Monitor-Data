...
FIELD_SYNONYMS: dict[str, tuple[str, ...]] = {
    ...
    "attack_angle_deg": ("attack angle", "aoa", "club aoa"),
    ...
    "total_yd": ("total", "total distance", "total dist", "total_yds"),
    "apex_native": (
        "apex",
        "apex height",
        "peak height",
...
SOURCES: tuple[ShotSource, ...] = (
    ...
    ShotSource(
        "mcgonzalez_launch_tracker_demo",
        "mcgonzalez79/launch-tracker",
        "d36d38f97ed8e9eb33977c12ea7ced3b18741a94",
        ("public/sampledata.csv",),
        "Garmin Approach R10 (schema match)",
        "real measurements with dates scrubbed to a single timestamp",
    ),
    ShotSource(
        "parbuddy_garmin_shots",
        "SumitNalavade/ParBuddy",
        "17efde1674a46bff3ebfad42ea333391277275bc",
        ("data/range_shots_rows.csv",),
        "Garmin Approach R10 (schema match)",
        "external_shots file excluded as a byte-identical duplicate of "
        "edwardxiong_832_trajectory",
    ),
    ShotSource(
        "edwardxiong_832_trajectory",
        "edwardxiong2027/golfswing-trajectory",
        "9c6470797346d1a2bf50368a557c83b80a2ddb0c",
        ("data/golf_trajectory.csv",),
        "Garmin Approach R10 (schema match)",
        "MIT licensed; companion paper calls it a TrackMan export but the "
        "headers are the Garmin Golf app schema",
    ),
    ShotSource(
        "tweakydragon_golf_app",
        "tweakydragon/golf_app",
        "4b0e612a95508f9829d70c3da5ab998424dcf5fc",
        ("sample_data/garmin/*.csv", "sample_data/ags-shots-*.csv"),
        "Garmin Approach R10; Awesome Golf app",
        "player name anonymized on load",
    ),
    ShotSource(
        "russosanti_mevo_plus_session",
        "russosanti/golf-metrics",
        "a8143dd727f55258a18dca4ee01fc2e13f1392ff",
        ("data/sessions/*.csv",),
        "FlightScope Mevo+",
        "MIT licensed; Pro Package club data",
    ),
    ShotSource(
        "hercandres_wedge_sessions",
        "hercandres/Python-User-Interface",
        "5cf2a45c7e0f2516f3e57d0f150fd0734c6c641e",
        ("original_data_set.csv",),
        "Unidentified launch monitor",
        "MIT licensed",
    ),
    ShotSource(
        "jaberry835_gspro_shots",
        "jaberry835/craft",
        "d9ba51d360d25a893d24db2a862fac6bac557a4d",
        ("junior-web-main/data/workspaces/default/uploads/PlayerShots_*.csv",),
        "GSPro shot list (upstream monitor unknown)",
        "club speed zero throughout; upstream unit lacked club tracking",
    ),
    ShotSource(
        "noahbkim_range_session",
        "noahbkim/golf",
        "a0e9efdea47bb6d59b64c1ae9e7930aa29369f0e",
        ("data/*.csv",),
        "Unidentified launch monitor (Uneekor-style export)",
        "MIT licensed",
    ),
    ShotSource(
        "zaku27_mevo_plus_shots",
        "Zaku27/MyGolfClubs",
        "f2fda6e05b3980e7f3d9baa163840e071ecace9b",
        ("public/*shots.csv",),
        "FlightScope Mevo+",
        "six-shot FS Golf app export",
    ),
)
